...
// - За нечетни числа, по-големи от 2, проверяваме модулна делимост, започвайки от 3 до квадратния корен от числото, като увеличаваме с 2 (за да пропуснем четните числа). Тези числа не са прости.
